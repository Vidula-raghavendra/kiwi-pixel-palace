  ...
  public: {
    Tables: {
      ...
      team_chat_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "team_chat_snapshots_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "team_chat_snapshots_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      team_chats: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "team_chats_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      team_todo_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "team_todo_snapshots_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "team_todo_snapshots_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
